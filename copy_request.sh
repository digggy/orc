...
REQUEST_METHOD=POST;CONTENT_TYPE=application/yang-data+json;HTTP_ACCEPT=application/yang-data+json;REQUEST_URI=cgi-bin/restconf/operations/openwrt-system-operations:copy;CONTENT_LENGTH=500
