...
declare -a f_array=("ietf-yang-types" "ietf-interfaces" "ietf-inet-types" "openwrt-network" "openwrt-system"
  "openwrt-uci-extension" "openwrt-operations-extension" "restconf-example"
  "openwrt-system-operations" "openwrt-measurement-operations")
...
all_files=""
declare -a openwrt_f_array=("${f_array[@]:3:7}")
